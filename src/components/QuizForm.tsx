...
const QuizForm = ({ origem }: QuizFormProps) => {
  ...
  const handleSubmit = async () => {
    ...
    const payload = {
      ...
      utm_content: params.get("utm_content") || origem,
      utm_term: params.get("utm_term") || "",
      faturamento: (answers[0] as string) || "",
            ...
            {currentStep.type === "contact" && (
              <div className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-4 rounded-lg bg-cta text-cta-foreground font-bold text-base hover:brightness-110 transition-all disabled:opacity-60"
                >
                  {isSubmitting ? "Enviando..." : "Quero receber minhas condições no WhatsApp"}
                </button>
